...
CREATE TABLE IF NOT EXISTS public.review (
  ...
  INSERT INTO public.review (review_rating, review_text, review_date, account_id, inv_id)
  VALUES (
    4,
    'Very nice, Gets the job done',
    2024/01/12,
    1,
    2,
  ),
  (
    2,
    'It always breaks down, but it works sometimes.',
    2023/02/12,
    2,
    11,
  )