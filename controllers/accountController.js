...
async function buildAccount(req, res) {
  ...
  const reviewData = await invModel.getReviewByAccountId(account_id)
  const list = await utilities.buildReviewList(reviewData, true)
...
/* ****************************************
 *  Logout of account/delete jwt cookie
 * ************************************ */
